...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://dandingbobaishi.github.io/", // 请替换为你的站点URL，以斜杠结尾
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/dandingbobaishi",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3546389703297185",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/dandingbobaishi",
					external: true,
					icon: "mdi:git",
				},
			],
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://dandingbobaishi.vercel.app",
		lang: SITE_LANG,
	},
};
